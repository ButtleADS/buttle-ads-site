...
const menuItems = [
  { name: "Pizza \"Margherita\"", price: "od 26 zł" },
  { name: "Makaron Carbonara",    price: "od 32 zł" },
  { name: "Tiramisu",           price: "od 13 zł" },
];
    ...
    <div className="demo-landing">
      ...
      <div className="demo-landing__promo">
        <p className="demo-landing__promo-title">
          🎁 Właściciel butelki otrzyma deser w prezencie!
        </p>
        <p className="demo-landing__promo-sub">Pokaż ten ekran kelnerowi</p>
      </div>
      ...
      <div className="demo-landing__rating">
        ...
        <span className="demo-landing__rating-text">4,9 • 847 opinii</span>
      </div>

      <div className="demo-landing__description">
        <p>
          Przygotowujemy potrawy z produktów pochodzących od lokalnych rolników. Każda potrawa to
          prawdziwa podróż do Włoch. Idealne miejsce na romantyczne kolacje i spotkania biznesowe.
        </p>
      </div>
      ...
      <div className="demo-landing__info">
        <div className="demo-landing__info-row">
          ...
          <span>ul. Marszałkowska, 89, Warszawa</span>
        </div>
        <div className="demo-landing__info-row">
          <svg
            xmlns="http://www.w3.org/2000/svg"
