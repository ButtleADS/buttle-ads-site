              ...
              <form className="contact-card__form" onSubmit={handleSubmit}>
                <div className="form-row">
                  <div className="form-field">
                    <label className="form-field__label" htmlFor="name">Imię *</label>
                    <input
                ...
                <div className="form-row">
                  <div className="form-field">
                    <label className="form-field__label" htmlFor="phone">Telefon</label>
                    <input
                      className="form-field__input"
                      id="phone"
                  ...
                  <div className="form-field">
                    <label className="form-field__label" htmlFor="company">Firma</label>
                    <input
                      className="form-field__input"
                      id="company"
                ...
                <div className="form-field">
                  <label className="form-field__label" htmlFor="requestType">Rodzaj zapytania</label>
                  <select
                ...
                <div className="form-field">
                  <label className="form-field__label" htmlFor="message">Komunikat *</label>
                  <textarea
